...
* [Hermes Agent](https://hermes-agent.nousresearch.com/) ([GitHub](https://github.com/NousResearch/hermes-agent) ⭐ 236,505 | 🐛 36,016 | 🌐 Python | 📅 2026-08-26, [Nous Research X](https://x.com/NousResearch), [Teknium X](https://x.com/Teknium)) - MIT-licensed autonomous agent from Nous Research with persistent memory, self-created skills, scheduled automations, subagents, sandboxed execution, and messaging gateways.
* [Orca](https://www.onorca.dev/) ([GitHub](https://github.com/stablyai/orca) ⭐ 53,743 | 🐛 4,582 | 🌐 TypeScript | 📅 2026-08-26) - Worktree-based IDE for running Claude Code, Codex, OpenCode, and other coding agents side by side across isolated git branches with review and PR workflow support.
* [oh-my-codex](https://github.com/Yeachan-Heo/oh-my-codex) ⭐ 32,848 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-26 ([Website](https://yeachan-heo.github.io/oh-my-codex-website/), [npm](https://www.npmjs.com/package/oh-my-codex)) - MIT-licensed workflow layer for OpenAI Codex CLI with stronger default sessions, reusable skills, native hooks, HUD/status surfaces, project guidance, and team-style execution commands.
* [NanoClaw](https://nanoclaw.dev/) ([GitHub](https://github.com/qwibitai/nanoclaw) ⭐ 30,618 | 🐛 988 | 🌐 TypeScript | 📅 2026-08-25, [Docs](https://docs.nanoclaw.dev/)) - MIT-licensed personal AI assistant that runs Claude agents in isolated containers, connects to chat channels, keeps memory, schedules work, and uses skills as git branches.
* [Vibe Kanban](https://vibekanban.com/) ([GitHub](https://github.com/BloopAI/vibe-kanban) ⭐ 27,921 | 🐛 533 | 🌐 Rust | 📅 2026-04-24) - Apache-2.0 Kanban workspace for planning, running, reviewing, previewing, and shipping parallel coding-agent work across Claude Code, Codex, Gemini CLI, OpenCode, and related agents.
* [Superset](https://superset.sh/) ([GitHub](https://github.com/superset-sh/superset) ⭐ 13,362 | 🐛 565 | 🌐 TypeScript | 📅 2026-08-26) - Local code editor and control plane for parallel CLI coding agents across isolated git worktrees.
* [Sandcastle](https://github.com/mattpocock/sandcastle) ⭐ 7,654 | 🐛 138 | 🌐 TypeScript | 📅 2026-06-29 ([npm](https://www.npmjs.com/package/@ai-hero/sandcastle)) - MIT-licensed TypeScript library and CLI for orchestrating AI coding agents in isolated sandboxes with branch strategies, hooks, logs, templates, and merge-back workflows.
* [Microsoft Agent Governance Toolkit](https://github.com/microsoft/agent-governance-toolkit) ⭐ 6,118 | 🐛 244 | 🌐 Python | 📅 2026-08-25 - MIT-licensed runtime governance toolkit for AI agents with deterministic policy enforcement, zero-trust identity, execution sandboxing, SRE controls, and compliance checks.
* [Squad](https://bradygaster.github.io/squad/) ([GitHub](https://github.com/bradygaster/squad) ⭐ 3,123 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-26) - Alpha GitHub Copilot-based agent team system with repo-native specialist agents, persistent memory, coordinator routing, parallel work, and CLI/SDK packages.
* [Helmor](https://helmor.ai/) ([GitHub](https://github.com/dohooo/helmor) ⭐ 1,295 | 🐛 45 | 🌐 TypeScript | 📅 2026-08-22, [Releases](https://github.com/dohooo/helmor/releases) ⭐ 1,295 | 🐛 45 | 🌐 TypeScript | 📅 2026-08-22) - Apache-2.0 local-first IDE and workbench for orchestrating Claude Code, Codex, and other coding agents across worktrees through planning, running, review, testing, merge, and shipping loops.
* [Open Swarm](https://openswarm.com/) ([GitHub](https://github.com/openswarm-ai/openswarm) ⭐ 802 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-25, [Docs](https://docs.openswarm.com), [Releases](https://github.com/openswarm-ai/openswarm/releases) ⭐ 802 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-25) - MIT-licensed local mission-control center for launching, monitoring, approving, and coordinating multiple AI agents in parallel.
...
* [Orca](https://www.onorca.dev/) ([GitHub](https://github.com/stablyai/orca) ⭐ 53,743 | 🐛 4,582 | 🌐 TypeScript | 📅 2026-08-26) - Desktop environment for running multiple coding agents safely in parallel across worktrees.
* [Multica](https://multica.ai/) ([GitHub](https://github.com/multica-ai/multica) ⭐ 47,705 | 🐛 1,380 | 🌐 Go | 📅 2026-08-26) - Managed agents platform where coding agents act like teammates, take issues, and reuse shared skills.
...
* [Vibe Kanban](https://vibekanban.com/) ([GitHub](https://github.com/BloopAI/vibe-kanban) ⭐ 27,921 | 🐛 533 | 🌐 Rust | 📅 2026-04-24) - Kanban workspace for planning issues, running coding agents in branches with terminals and dev servers, reviewing diffs, previewing apps, opening pull requests, and merging finished work.
* [Gas Town](https://github.com/gastownhall/gastown) ⭐ 17,780 | 🐛 438 | 🌐 Go | 📅 2026-08-19 ([GitHub](https://github.com/gastownhall/gastown) ⭐ 17,780 | 🐛 438 | 🌐 Go | 📅 2026-08-19) - Multi-agent workspace manager for Claude Code, GitHub Copilot, Codex, Gemini, and other coding agents with persistent work tracking.
* [Superset](https://superset.sh/) ([GitHub](https://github.com/superset-sh/superset) ⭐ 13,362 | 🐛 565 | 🌐 TypeScript | 📅 2026-08-26) - Local code editor and control plane for parallel CLI coding agents across isolated git worktrees.
* [Sandcastle](https://github.com/mattpocock/sandcastle) ⭐ 7,654 | 🐛 138 | 🌐 TypeScript | 📅 2026-06-29 ([npm](https://www.npmjs.com/package/@ai-hero/sandcastle)) - MIT-licensed TypeScript library and CLI for orchestrating AI coding agents in isolated sandboxes with branch strategies, hooks, logs, templates, and merge-back workflows.
* [Helmor](https://helmor.ai/) ([GitHub](https://github.com/dohooo/helmor) ⭐ 1,295 | 🐛 45 | 🌐 TypeScript | 📅 2026-08-22) - Apache-2.0 local-first IDE and workbench for orchestrating Claude Code, Codex, and other coding agents across worktrees through planning, running, review, testing, merge, and shipping loops.
* [Open Swarm](https://openswarm.com/) ([GitHub](https://github.com/openswarm-ai/openswarm) ⭐ 802 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-25, [Docs](https://docs.openswarm.com)) - MIT-licensed local mission-control center for launching, monitoring, approving, and coordinating multiple AI agents in parallel.
...
* [OpenClaw](https://openclaw.ai/) ([GitHub](https://github.com/openclaw/openclaw) ⭐ 387,635 | 🐛 5,876 | 🌐 TypeScript | 📅 2026-08-26) - Open-source personal AI assistant software built around chat, persistent context, skills, and execution.
* [Hermes Agent](https://hermes-agent.nousresearch.com/) ([GitHub](https://github.com/NousResearch/hermes-agent) ⭐ 236,505 | 🐛 36,016 | 🌐 Python | 📅 2026-08-26) - MIT-licensed autonomous agent from Nous Research with persistent memory, self-created skills, scheduled automations, subagents, sandboxed execution, and messaging gateways.
* [Dify](https://dify.ai/) ([GitHub](https://github.com/langgenius/dify) ⭐ 153,525 | 🐛 949 | 🌐 TypeScript | 📅 2026-08-26) - Agentic workflow builder that combines workflows, chatflows, apps, and knowledge systems.
...
* [Agno](https://agno.com/) ([GitHub](https://github.com/agno-agi/agno) ⭐ 41,925 | 🐛 1,300 | 🌐 Python | 📅 2026-08-26) - Production runtime for agentic software with agents, teams, workflows, and AgentOS services.
* [NanoClaw](https://nanoclaw.dev/) ([GitHub](https://github.com/qwibitai/nanoclaw) ⭐ 30,618 | 🐛 988 | 🌐 TypeScript | 📅 2026-08-25, [Docs](https://docs.nanoclaw.dev/)) - MIT-licensed personal AI assistant that runs Claude agents in isolated containers, connects to chat channels, keeps memory, schedules work, and uses skills as git branches.
* [Sim](https://www.sim.ai/) ([GitHub](https://github.com/simstudioai/sim) ⭐ 29,473 | 🐛 290 | 🌐 TypeScript | 📅 2026-08-26) - Open-source AI agent platform for building agents with integrations, workflows, knowledge bases, and docs.
* [Mastra](https://mastra.ai/) ([GitHub](https://github.com/mastra-ai/mastra) ⭐ 27,474 | 🐛 462 | 🌐 TypeScript | 📅 2026-08-26) - TypeScript framework for agents, graph-based workflows, MCP servers, evals, observability, and production AI applications.
* [Cabinet](https://runcabinet.com/) ([GitHub](https://github.com/hilash/cabinet) ⭐ 2,839 | 🐛 73 | 🌐 TypeScript | 📅 2026-08-25) - AI-first knowledge base where files live on disk and agents help with execution.
...
* [Paperclip](https://paperclip.ing/) ([GitHub](https://github.com/paperclipai/paperclip) ⭐ 79,382 | 🐛 5,363 | 🌐 TypeScript | 📅 2026-08-26) - Open-source orchestration for zero-human companies, centered on AI employees, goals, and jobs.
* [CrewAI](https://www.crewai.com/) ([GitHub](https://github.com/crewAIInc/crewAI) ⭐ 57,616 | 🐛 807 | 🌐 Python | 📅 2026-08-26) - Multi-agent system organized around specialized crews, roles, and delegation.
* [Squad](https://bradygaster.github.io/squad/) ([GitHub](https://github.com/bradygaster/squad) ⭐ 3,123 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-26) - Alpha GitHub Copilot-based system where specialist agents live in the repo, keep memory, share decisions, route work through a coordinator, and run in parallel.
